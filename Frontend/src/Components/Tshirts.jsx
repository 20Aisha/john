...
function Tshirts() {
  ...
  return (
    ...
    <div className='mmmmiok' >
      <div style={{ backgroundImage: `url(${tatus})` }}>
        <div className='ml-5 p-5' style={{ textAlign: "left" }}>
          <h1 className='fgd font-extrabold	mkjbbfss ' style={{ fontSize: 100 }}>T-Shirts</h1> 
   ...
   <div className='CardHover' >
       <img src={shirt} class="carousal-img img-fluid" style={{  width : "60%" , height : "50%" }} />
   <div class="member-text">
     <h4 className='name' >  Menace Shirt Design</h4>
