...
import Hoodiesde from '../assets/images/home-hoodies.png'
...
function Hoodies() {
  ...
  const getAllProducts = async () => {
    try {
      const response = await axios.get(`https://cheerful-shoulder-pads-hare.cyclic.app/api/v1/paginatpost?page=${page}`);
  ...
  return (
    <div>
      ...
      <div className='mmmmiok' >
        <div style={{ backgroundImage: `url(${tatus})` }}>
          <div className='ml-5 p-5' style={{ textAlign: "left" }}>
            <h1 className='fgd font-extrabold	mkjbbfss ' style={{ fontSize: 100 }}>Hoodies</h1> 
     ...
     <div className='CardHover' >
         <img src={Hoodiesde} class="carousal-img img-fluid" style={{  width : "60%" , height : "50%" }} />
     <div class="member-text">
       <h4 className='name' >  Menace Hoodies Design</h4>
