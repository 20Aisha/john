...
function Shorts() {
  ...
  return (
    ...
    <div className='mmmmiok' >
      <div style={{ backgroundImage: `url(${tatus})` }}>
        <div className='ml-5 p-5' style={{ textAlign: "left" }}>
          <h1 className='fgd font-extrabold	mkjbbfss ' style={{ fontSize: 100 }}>Shorts </h1> 
   ...
   <div className='CardHover' >
       <img src={shorts} class="carousal-img img-fluid" style={{  width : "60%" , height : "50%" }} />
   <div class="member-text">
     <h4 className='name' >  Menace shorts Design</h4>
